...
import 'package:optival/core/presentation/app_padding.dart';
import 'package:optival/core/presentation/app_text.dart';
...
class _WeatherWidgetState extends ConsumerState<WeatherWidget> {
  ...
  Widget build(BuildContext context) {
    final weatherState = ref.watch(
        weatherStateNotifierProvider); // TODO: 8-) weatherState değişkeni oluşturup providerımız aracılığıyla state değerine ulaşıyoruz.
